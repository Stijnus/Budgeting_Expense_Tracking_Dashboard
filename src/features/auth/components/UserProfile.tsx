      ...
      <div className="p-4 bg-white rounded-lg shadow">
          ...
          <form onSubmit={handlePasswordChange} className="space-y-4">
            ...
            {passwordSuccessMessage && (
              <p className="text-sm text-green-600 flex items-center gap-1">
                <CheckCircle size={16} /> {passwordSuccessMessage}
              </p>
            )}
            {/* Submit Button */}
            <div>
        ...
        <div className="mt-8 pt-6 border-t border-red-300 bg-red-50 p-4 rounded-md">
          ...
          <p className="mt-2 text-sm text-red-700">
            ...
            personal data, expenses, budgets, categories, and household
      ...
      {isDeleteModalOpen && (
        ...
        >
          ...
          >
            <h2
              id="modal-title"
              className="text-lg font-bold text-red-800 mb-3 flex items-center gap-2"
            >
              <ShieldAlert size={20} /> Are you absolutely sure?
            </h2>
            <p className="text-sm text-gray-600 mb-4">
              This action is irreversible. To confirm deletion, please type your
              email address (
