// src/features/budgets/components/MonthlyReport.tsx
...
export default function MonthlyReport() {
  ...
  const fetchReportData = useCallback(async (year: number, month: number) => {
    ...
    try {
      ...
      const expenses: Pick<Expense, "amount" | "category_id" | "categories">[] =
        expensesResult.data || [];
      ...
      const expensesByCategory = Object.values(expensesByCategoryMap).sort(
        (a, b) => b.total - a.total
