...
const AppLayout: React.FC<AppLayoutProps> = ({ children, session, currentView, onNavigate, loading }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      />
      <div className="flex flex-1 overflow-hidden"> {/* Use overflow-hidden here */}
        <Sidebar
            currentView={currentView}
            onNavigate={onNavigate}
