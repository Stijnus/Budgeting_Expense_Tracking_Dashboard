                ...
                <div className="mt-4 pt-4 border-t border-gray-200">
                    ...
                    <form onSubmit={handlePasswordChange} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input id="new-password" type="password" /* ... */ value={newPassword} onChange={(e) => setNewPassword(e.target.value)} disabled={passwordLoading} />
                            <p className="mt-1 text-xs text-gray-500">Must be at least 6 characters long.</p>
                        </div>
                        <div>
                            <label htmlFor="confirm-password" /* ... */>Confirm New Password</label>
                            <input id="confirm-password" type="password" /* ... */ value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} disabled={passwordLoading} />
                        </div>
                        {/* Feedback Messages */}
